package com.anningtex.groupedrecyclerviewadapter.menu;
...
import com.anningtex.groupedrecyclerviewadapter.R;
 ...
 * @Author: Song
 */
public abstract class GroupedRecyclerViewAdapter<D extends GroupEntity> extends BaseRecyclerViewAdapter<D, RecyclerView.ViewHolder> {
    ...
    public boolean isExpand(int groupPosition) {
        GroupEntity entity = data.get(groupPosition);
